...
<script>
import DeleteCarAdDialog from '../dialogs/carAds-dialogs/DeleteCarAdDialog';
import UpdateCarAdDialog from '../dialogs/carAds-dialogs/UpdateCarAdDialog';
import AddCarAdDialog from '../dialogs/carAds-dialogs/AddCarAdDialog';
import InfoCarAdDialog from '../dialogs/carAds-dialogs/InfoCarAdDialog';
import { mapState } from "vuex";
import { adMixin } from "../../mixins/adMixin";
import { userMixin } from "../../mixins/userMixin";
export default {
  components: {
    'app-delete-car-ad-dialog': DeleteCarAdDialog,
    'app-update-car-ad-dialog': UpdateCarAdDialog,
    'app-add-car-ad-dialog': AddCarAdDialog,
    'app-info-car-ad-dialog': InfoCarAdDialog
  },
  mixins: [
    adMixin,
    userMixin
  ...
  computed: {
    ...mapState(["carsCollection"]),
    filteredAds() {
      return this.carsCollection.filter((item) => {
  ...
  mounted() {
    this.$store.dispatch("getCarCollection");
  },
};
</script>
<style scoped>
