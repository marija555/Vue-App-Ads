...
<script>
import DeleteComputerAdDialog from '../dialogs/computerAds-dialogs/DeleteComputerAdDialog';
import UpdateComputerAdDialog from '../dialogs/computerAds-dialogs/UpdateComputerAdDialog';
import AddComputerAdDialog from '../dialogs/computerAds-dialogs/AddComputerAdDialog';
import InfoComputerAdDialog from '../dialogs/computerAds-dialogs/InfoComputerAdDialog';
import { mapState } from "vuex";
import { adMixin } from "../../mixins/adMixin";
import { userMixin } from "../../mixins/userMixin";
export default {
  components: {
    'app-delete-computer-ad-dialog': DeleteComputerAdDialog,
    'app-update-computer-ad-dialog': UpdateComputerAdDialog,
    'app-add-computer-ad-dialog': AddComputerAdDialog,
    'app-info-computer-ad-dialog': InfoComputerAdDialog
  },
  computed: {
    ...mapState(["computersCollection"]),
    filteredAds() {
      return this.computersCollection.filter((item) => {
