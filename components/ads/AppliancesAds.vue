...
<script>
import DeleteApplianceAdDialog from '../dialogs/applianceAds-dialogs/DeleteApplianceAdDialog';
import UpdateApplianceAdDialog from '../dialogs/applianceAds-dialogs/UpdateApplianceAdDialog';
import AddApplianceAdDialog from '../dialogs/applianceAds-dialogs/AddApplianceAdDialog';
import InfoApplianceAdDialog from '../dialogs/applianceAds-dialogs/InfoApplianceAdDialog';
import { mapState } from "vuex";
import { userMixin } from "../../mixins/userMixin";
import { adMixin } from "../../mixins/adMixin";
export default {
  components: {
    'app-delete-appliance-ad-dialog': DeleteApplianceAdDialog,
    'app-update-appliance-ad-dialog': UpdateApplianceAdDialog,
    'app-add-appliance-ad-dialog': AddApplianceAdDialog,
    'app-info-appliance-ad-dialog': InfoApplianceAdDialog
  },
  computed: {
    ...mapState(["appliancesCollection"]),
    filteredAds() {
      return this.appliancesCollection.filter((item) => {
  ...
  mounted() {
    this.$store.dispatch("getApplianceCollection");
  },
};
</script>
<style scoped>
