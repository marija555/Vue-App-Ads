...
<script>
import DeleteClothesAdDialog from '../dialogs/clothesAds-dialogs/DeleteClothesAdDialog';
import UpdateClothesAdDialog from '../dialogs/clothesAds-dialogs/UpdateClothesAdDialog';
import AddClothesAdDialog from '../dialogs/clothesAds-dialogs/AddClothesAdDialog';
import InfoClothesAdDialog from '../dialogs/clothesAds-dialogs/InfoClothesAdDialog';
import { mapState } from "vuex";
import { adMixin } from "../../mixins/adMixin";
import { userMixin } from "../../mixins/userMixin";
export default {
  components: {
    'app-delete-clothe-ad-dialog': DeleteClothesAdDialog,
    'app-update-clothe-ad-dialog': UpdateClothesAdDialog,
    'app-add-clothe-ad-dialog': AddClothesAdDialog,
    'app-info-clothe-ad-dialog': InfoClothesAdDialog
  },
  computed: {
    ...mapState(["clothesCollection"]),
    filteredAds() {
      return this.clothesCollection.filter((item) => {
