...
<script>
import DeleteCosmeticAdDialog from '../dialogs/cosmeticAds-dialogs/DeleteCosmeticAdDialog';
import UpdateCosmeticAdDialog from '../dialogs/cosmeticAds-dialogs/UpdateCosmeticAdDialog';
import AddCosmeticAdDialog from '../dialogs/cosmeticAds-dialogs/AddCosmeticAdDialog';
import InfoCosmeticAdDialog from '../dialogs/cosmeticAds-dialogs/InfoCosmeticAdDialog';
import { mapState } from "vuex";
import { adMixin } from "../../mixins/adMixin";
import { userMixin } from "../../mixins/userMixin";
export default {
  components: {
    'app-delete-cosmetic-ad-dialog': DeleteCosmeticAdDialog,
    'app-update-cosmetic-ad-dialog': UpdateCosmeticAdDialog,
    'app-add-cosmetic-ad-dialog': AddCosmeticAdDialog,
    'app-info-cosmetic-ad-dialog': InfoCosmeticAdDialog
  },
  mixins: [
    adMixin,
    userMixin
  ...
  computed: {
    ...mapState(["cosmeticsCollection"]),
    filteredAds() {
      return this.cosmeticsCollection.filter((item) => {
  ...
  mounted() {
    this.$store.dispatch("getCosmeticCollection");
  },
};
</script>
<style scoped>
