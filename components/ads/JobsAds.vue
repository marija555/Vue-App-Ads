...
<script>
import DeleteJobAdDialog from '../dialogs/jobAds-dialogs/DeleteJobAdDialog';
import UpdateJobAdDialog from '../dialogs/jobAds-dialogs/UpdateJobAdDialog';
import AddJobAdDialog from '../dialogs/jobAds-dialogs/AddJobAdDialog';
import InfoJobAdDialog from '../dialogs/jobAds-dialogs/InfoJobAdDialog';
import { mapState } from "vuex";
import { adMixin } from "../../mixins/adMixin";
import { userMixin } from "../../mixins/userMixin";
export default {
  components: {
    'app-delete-job-ad-dialog': DeleteJobAdDialog,
    'app-update-job-ad-dialog': UpdateJobAdDialog,
    'app-add-job-ad-dialog': AddJobAdDialog,
    'app-info-job-ad-dialog': InfoJobAdDialog
  },
  mixins: [
    adMixin,
    userMixin
  ...
  computed: {
    ...mapState(["jobsCollection"]),
    filteredAds() {
      return this.jobsCollection.filter((item) => {
