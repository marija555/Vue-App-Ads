...
<script>
import DeleteHomeAdDialog from '../dialogs/homeAds-dialogs/DeleteHomeAdDialog';
import UpdateHomeAdDialog from '../dialogs/homeAds-dialogs/UpdateHomeAdDialog';
import AddHomeAdDialog from '../dialogs/homeAds-dialogs/AddHomeAdDialog';
import InfoHomeAdDialog from '../dialogs/homeAds-dialogs/InfoHomeAdDialog';
import { mapState } from "vuex";
import { adMixin } from "../../mixins/adMixin";
import { userMixin } from "../../mixins/userMixin";
export default {
  components: {
    'app-delete-home-ad-dialog': DeleteHomeAdDialog,
    'app-update-home-ad-dialog': UpdateHomeAdDialog,
    'app-add-home-ad-dialog': AddHomeAdDialog,
    'app-info-home-ad-dialog': InfoHomeAdDialog
  },
  mixins: [
    adMixin,
    userMixin
  ...
  computed: {
    ...mapState(["homesCollection"]),
    filteredAds() {
      return this.homesCollection.filter((item) => {
